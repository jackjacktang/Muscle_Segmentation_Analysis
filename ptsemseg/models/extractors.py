...
'''
model_urls = {
    'resnet18': '/media/jacktang/Work/USYD/Research/Deep_Learning/Pretrained/Resnet/resnet18-5c106cde.pth',
    'resnet34': '/media/jacktang/Work/USYD/Research/Deep_Learning/Pretrained/Resnet/resnet34-333f7ec4.pth',
    'resnet50': '/media/jacktang/Work/USYD/Research/Deep_Learning/Pretrained/Resnet/resnet50-19c8e357.pth',
    'resnet101': '/media/jacktang/Work/USYD/Research/Deep_Learning/Pretrained/Resnet/resnet101-5d3b4d8f.pth',
    'resnet152': '/media/jacktang/Work/USYD/Research/Deep_Learning/Pretrained/Resnet/resnet152-b121ed2d.pth',
}
...
def resnet34(pretrained=True):
    ...
    if pretrained:
        # state = convert_state_dict(torch.load(model_urls['resnet34']))
        # model.load_state_dict(state)

        load_weights_sequential(model, torch.load(model_urls['resnet34']))
